...
EXTERN_C const IID IID_IMyMath;
    ...
    MIDL_INTERFACE("B0FE292F-19A0-4902-BCAA-F3003C3DC3A1")
...
#ifndef __AutomationServerWithRegFileLib_LIBRARY_DEFINED__
#define __AutomationServerWithRegFileLib_LIBRARY_DEFINED__

/* library AutomationServerWithRegFileLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_AutomationServerWithRegFileLib;

EXTERN_C const CLSID CLSID_CMyMath;

#ifdef __cplusplus

class DECLSPEC_UUID("72F41EB2-0CD2-4A49-8E9D-18716E90B80C")
CMyMath;
#endif
#endif /* __AutomationServerWithRegFileLib_LIBRARY_DEFINED__ */
